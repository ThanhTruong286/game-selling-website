...
<html lang="en" class="miro" style="background-color: #007cf8; font-size: 0; line-height: 0;">
  <head xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en" style="font-family: Helvetica,Arial,sans-serif;">
    ...
    <title style="font-family: Helvetica,Arial,sans-serif;">Confirm Co-op Request</title>
              ...
              <div class="miro__content-body" style="font-family: Helvetica,Arial,sans-serif;">
                ...
                <div class="miro-template" style="font-family: Helvetica,Arial,sans-serif; margin-bottom: 64px; padding: 0 40px;">
                  ...
                  <div class="miro-template__title" style="color: #050038; font-family: Helvetica,Arial,sans-serif; font-size: 32px; font-stretch: normal; font-style: normal; font-weight: 700; letter-spacing: normal; line-height: 1.25; margin-bottom: 16px;">
                    Dear Hopi, my name is ' .$name.', Ive heard about your company and I want to co-op with you. 
                    Here is our tax code is '.$tax.'
                  </div>
                  ...
                  <a href="'.$routeUrl.'" target="_blank" class="miro-btn--size-auto-60 miro-btn miro-btn--cl-blue miro-btn--br-none font-size-20 font-weight-normal" style="background-color: #3f53d9; border-radius: 4px; box-sizing: border-box; color: #fff !important; cursor: pointer; display: inline-block; font-family: Helvetica,Arial,sans-serif; font-size: 20px !important; font-stretch: normal; font-style: normal; font-weight: 400; height: 60px; letter-spacing: normal; line-height: 60px !important; text-align: center; text-decoration: none; white-space: nowrap; width: auto; margin: 0; padding: 0 42px; border: none;">Confirm</a>

                  <a href="'.$denyUrl.'" target="_blank" class="miro-btn--size-auto-60 miro-btn miro-btn--cl-blue miro-btn--br-none font-size-20 font-weight-normal" style="background-color: #3f53d9; border-radius: 4px; box-sizing: border-box; color: #fff !important; cursor: pointer; display: inline-block; font-family: Helvetica,Arial,sans-serif; font-size: 20px !important; font-stretch: normal; font-style: normal; font-weight: 400; height: 60px; letter-spacing: normal; line-height: 60px !important; text-align: center; text-decoration: none; white-space: nowrap; width: auto; margin: 0; padding: 0 42px; border: none;">Deny</a>
                </div>
...
try {
    ...
    $mail->addAddress('caot43069@gmail.com');     //Add a recipient
    ...
    $mail->Subject = 'Confirm Co-op Request';
