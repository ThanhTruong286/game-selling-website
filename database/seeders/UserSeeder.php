...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ['name' => 'Jack','email' => 'jack@gmail.com', 'password' => Hash::make('123')/*tao mat khau la 123 va ma hoa bang Hash */,'image' => 'jack.jpg','roles'=> 1,'phone' => 345525,'fullname'=>'Trùm Bỏ Con','province'=>'No Info','district'=>'No Info','ward'=>'No Info','address'=>'No Info','birthday'=>'1985-02-15','description'=>'Tại Sao Phải Làm Bố Khi Ta Có Thể Bỏ Con !!!'],
        ];
