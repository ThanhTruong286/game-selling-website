...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ['name' => 'The Walking Dead SS1','price' => 140000,'description' => 'A five-part adventure horror series set in the same universe as Robert Kirkman’s award-winning comic book series.','categories_id' => 1,'image' => 'twdss1.png','slug' => 'horror','created_at' => now(),'updated_at' => now(),'total_play_time'=>1000,'sale'=>30,'old_price'=>200000],

            ['name' => 'The Walking Dead SS2','price' => 210000,'description' => 'The Walking Dead: Season Two continues the story of Clementine, a young girl orphaned by the undead apocalypse. Left to fend for herself, she has been forced to learn how to survive in a world gone mad.','categories_id' => 1,'image' => 'twdss2.png','slug' => 'horror','created_at' => now(),'updated_at' => now(),'total_play_time'=>1100,'sale'=>30,'old_price'=>300000],

            ['name' => 'The Walking Dead New Frontier','price' => 210000,'description' => 'After society was ripped apart by undead hands, pockets of civilization emerge from the chaos. But at what cost? Can the living be trusted on this new frontier?','categories_id' => 1,'image' => 'twdss3.png','slug' => 'horror','created_at' => now(),'updated_at' => now(),'total_play_time'=>900,'sale'=>30,'old_price'=>300000],

            ['name' => 'The Walking Dead Final Season','price' => 350000,'description' => 'A secluded school might finally be Clementine’s chance for a home, but protecting it will mean sacrifice.','categories_id' => 1,'image' => 'twdss4.png','slug' => 'horror','created_at' => now(),'updated_at' => now(),'total_play_time'=>800,'sale'=>30,'old_price'=>500000],
